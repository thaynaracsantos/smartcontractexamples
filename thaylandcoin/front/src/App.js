...
import abi from "./contracts/ThaylandCoin.json";
...
function App() {
  ...
  const contractAddress = '0xC835f1EF3aA5d337a0ca7F3626CDA1fd040a7D65';
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">Thayland Coin Project</span>
        <img className="inline p-3 ml-2" src="https://i.imgur.com/5JfHKHU.png" alt="Thayland Coin" width="60" height="30" />
      </h2>
